    ...
    public partial class totaltravel_DBContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<VW_tbPaquetesHabitaciones>(entity =>
            {
                ...
                entity.Property(e => e.Paquete_Descripcion).IsUnicode(false);

                entity.Property(e => e.Paquete_Duracion)
                    .HasMaxLength(50)
                    .IsUnicode(false);

                entity.Property(e => e.Paquete_Nombre)
                    .HasMaxLength(50)
                    .IsUnicode(false);

                entity.Property(e => e.Paquete_Precio).HasColumnType("money");
            ...
            modelBuilder.Entity<VW_tbRegistrosPagos>(entity =>
            {
                ...
                entity.Property(e => e.nombre_paquete)
                    .HasMaxLength(50)
                    .IsUnicode(false);

                entity.Property(e => e.precio_paquete).HasColumnType("money");
            });
            ...
            modelBuilder.Entity<VW_tbUsuariosLogins>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("VW_tbUsuariosLogins", "Acce");
            ...
            modelBuilder.Entity<tbActividadesExtras>(entity =>
            {
                ...
                entity.Property(e => e.AcEx_Url).IsUnicode(false);
            ...
            modelBuilder.Entity<tbPaises>(entity =>
            {
                ...
                entity.HasIndex(e => e.Pais_Codigo)
                    .HasName("UQ__tbPaises__BC5364F99891626A")
                    .IsUnique();
            ...
            modelBuilder.Entity<tbPartners>(entity =>
            {
                ...
                entity.Property(e => e.Part_Url).IsUnicode(false);
            ...
            modelBuilder.Entity<tbReservaciones>(entity =>
            {
                ...
                entity.HasOne(d => d.Usua_)
                    .WithMany(p => p.tbReservacionesUsua_)
            ...
            modelBuilder.Entity<tbReservacionesHoteles>(entity =>
            {
                ...
                entity.HasOne(d => d.Hote_)
                    ...
                    .HasForeignKey(d => d.Hote_ID)
                    .HasConstraintName("FK_tbReservacionesHoteles_tbHoteles_HoteID");
            ...
            modelBuilder.Entity<tbUsuarios>(entity =>
            {
                ...
                entity.Property(e => e.Usua_Url).IsUnicode(false);
