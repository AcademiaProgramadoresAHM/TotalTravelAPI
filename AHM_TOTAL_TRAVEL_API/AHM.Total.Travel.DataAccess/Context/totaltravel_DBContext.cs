...
namespace AHM.Total.Travel.DataAccess.Context
{
    public partial class totaltravel_DBContext : DbContext
    {
        ...
        public virtual DbSet<VW_PaquetePredeterminados> VW_PaquetePredeterminados { get; set; }
        public virtual DbSet<VW_ReservacionRestaurante> VW_ReservacionRestaurante { get; set; }
        public virtual DbSet<VW_ReservacionTransporte> VW_ReservacionTransporte { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<VW_PaquetePredeterminados>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("VW_PaquetePredeterminados", "Sale");
            ...
            modelBuilder.Entity<VW_ReservacionRestaurante>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("VW_ReservacionRestaurante", "Resv");
            ...
            modelBuilder.Entity<VW_ReservacionTransporte>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("VW_ReservacionTransporte", "Resv");
            ...
            modelBuilder.Entity<VW_tbCategoriasHabitaciones>(entity =>
            {
                ...
                entity.Property(e => e.CaHa_FechaCreacion).HasColumnType("datetime");
            ...
            modelBuilder.Entity<VW_tbRolesPermisos>(entity =>
            {
                ...
                entity.Property(e => e.Descripcion_Per)
                    .HasMaxLength(50)
                    .IsUnicode(false);

                entity.Property(e => e.Descripcion_Rol)
                    .HasMaxLength(50)
                    .IsUnicode(false);
            ...
            modelBuilder.Entity<tbActividades>(entity =>
            {
                ...
                entity.Property(e => e.Actc_Descripcion)
                    .HasMaxLength(70)
                    .IsUnicode(false);

                entity.Property(e => e.Actc_Estado).HasDefaultValueSql("('1')");

                entity.Property(e => e.Actc_FechaCreacion)
                    .HasColumnType("datetime")
                    .HasDefaultValueSql("(getdate())");

                entity.Property(e => e.Actc_FechaModifica).HasColumnType("datetime");

                entity.HasOne(d => d.Actc_UsuarioCreacionNavigation)
                    .WithMany(p => p.tbActividadesActc_UsuarioCreacionNavigation)
                    .HasForeignKey(d => d.Actc_UsuarioCreacion);

                entity.HasOne(d => d.Actc_UsuarioModificaNavigation)
                    .WithMany(p => p.tbActividadesActc_UsuarioModificaNavigation)
                    .HasForeignKey(d => d.Actc_UsuarioModifica);
            ...
            modelBuilder.Entity<tbDetallesTransportes>(entity =>
            {
                ...
                entity.Property(e => e.Tprt_Matricula)
                    .HasMaxLength(20)
                    .IsUnicode(false);
