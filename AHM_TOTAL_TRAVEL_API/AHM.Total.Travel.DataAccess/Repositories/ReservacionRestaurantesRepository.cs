...
namespace AHM.Total.Travel.DataAccess.Repositories
{
    public class ReservacionRestaurantesRepository : IRepository<tbReservacionRestaurantes, VW_tbReservacionRestaurante>
    {
        ...
        public RequestStatus Delete(int ID, int Mod)
        {
            ...
            return db.QueryFirst<RequestStatus>(ScriptDataBase.UDP_tbReservacionRestaurantes_Delete, parameters, commandType: CommandType.StoredProcedure);
        }
        ...
        public RequestStatus Insert(tbReservacionRestaurantes item)
        {
            var parameters = new DynamicParameters();
            ...
            return db.QueryFirst<RequestStatus>(ScriptDataBase.UDP_tbReservacionRestaurantes_Insert, parameters, commandType: CommandType.StoredProcedure);
        }
        ...
        public RequestStatus Update(tbReservacionRestaurantes item, int id)
        {
            var parameters = new DynamicParameters();
            parameters.Add("@ReRe_ID", id, DbType.Int32, ParameterDirection.Input);
            parameters.Add("@Resv_ID", item.Resv_ID, DbType.Int32, ParameterDirection.Input);
            ...
            return db.QueryFirst<RequestStatus>(ScriptDataBase.UDP_tbReservacionRestaurantes_Update, parameters, commandType: CommandType.StoredProcedure);
        }
