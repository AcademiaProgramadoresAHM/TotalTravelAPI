...
namespace AHM.Total.Travel.DataAccess.Repositories
{
    public class ReservacionesActividadesHotelesRepository : IRepository<tbReservacionesActividadesHoteles, VW_tbReservacionesActividadesHoteles>
    {
        ...
        public int Delete(int ID, int Mod)
        {
            ...
            return db.ExecuteScalar<int>(ScriptDataBase.UDP_tbReservacionesActividadesHoteles_Delete, parameters, commandType: CommandType.StoredProcedure);
        }
        ...
        public int Insert(tbReservacionesActividadesHoteles item)
        {
            var parameters = new DynamicParameters();
            ...
            return db.ExecuteScalar<int>(ScriptDataBase.UDP_tbReservacionesActividadesHoteles_Insert, parameters, commandType: CommandType.StoredProcedure);
        }
        ...
        public int Update(tbReservacionesActividadesHoteles item, int id)
        {
            var parameters = new DynamicParameters();
            parameters.Add("@ReAH_ID", item.ReAH_ID, DbType.Int32, ParameterDirection.Input);
            parameters.Add("@Resv_ID", item.Resv_ID, DbType.Int32, ParameterDirection.Input);
            parameters.Add("@HoAc_ID", item.HoAc_ID, DbType.Int32, ParameterDirection.Input);
            parameters.Add("@ReAH_Cantidad", item.ReAH_Cantidad, DbType.Int32, ParameterDirection.Input);
            parameters.Add("@ReAH_FechaReservacion", item.ReAH_FechaReservacion, DbType.Int32, ParameterDirection.Input);
            ...
            return db.ExecuteScalar<int>(ScriptDataBase.UDP_tbReservacionesActividadesHoteles_Update, parameters, commandType: CommandType.StoredProcedure);
        }
    }
}
